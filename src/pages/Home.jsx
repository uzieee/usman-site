...
export default function Home() {
    ...
    return (
        <>
            <SplashSection splashMessage={'Usman Shafique'} isDarkMode={isDarkMode} isErrorMode={false} />
